...
public class EncounterService {
	...
	public ResponseEntity<ResponseStructure<Encounter>> saveEncounter(Encounter encounter, int pid, int bid) {
		...
		if (person != null) {
			if (branch != null) {
				...
				throw new IdNotFoundByBranchException("Id Not Found in Branch Entity is not exist");
			}
		} else {
			throw new IdNotFoundByPersonException("Id Not Found in Person Entity is not exist");
		}
	}
	...
	public ResponseEntity<ResponseStructure<Encounter>> updateEncounter(Encounter encounter, int eid, int bid) {
		...
		if (encounterdb != null && branch != null) {
			...
			throw new IdNotFoundByEncounterException("Encounter id Not  found");
		}
	}
	...
	public ResponseEntity<ResponseStructure<Encounter>> deleteEncounter(int eid) {
		...
		if (encounter != null) {
			...
			throw new IdNotFoundByEncounterException("Id Not Found");
		}
	}
	...
	public ResponseEntity<ResponseStructure<Encounter>> getEncounterById(int eid) {
		...
		if (encounter != null) {
			...
			throw new NoSuchElementFoundByEncounterlException("Id Not Found");
		}
	}
